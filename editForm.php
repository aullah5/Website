...
<body>
    ...
    <h2>Edit Contact</h2>
    <form method="post" action="contactAdded.php">
        ...
        Address <input type="text" name="address"> City <input type="text" name="city"><br>
        ...
        </select> Zip <input type="text" name="zip"><br>
    ...
    <hr>
    <a href="assignment3.php">Go Back to Search</a>
